...
CREATE TABLE partie (
PRIMARY KEY (idP ,DATEdb, Date_F),
idP serial,
DATEdb TIMESTAMP NOT NULL,
Date_F TIMESTAMP NOT NULL,
Duree TIME
);

CREATE TABLE TOUR (
PRIMARY KEY (idP,DATEdb, Date_F, Numero_T),
DATEdb TIMESTAMP NOT NULL,
Date_F TIMESTAMP NOT NULL,
...
PRIMARY KEY (idP ,DATEdb, Date_F,idj),
idP integer,
DATEdb TIMESTAMP NOT NULL,
Date_F TIMESTAMP NOT NULL,
idj serial not null,
...
ALTER TABLE TOUR ADD FOREIGN KEY (id) REFERENCES piece (id);
ALTER TABLE TOUR ADD FOREIGN KEY (idP,DATEdb, Date_F) REFERENCES partie (idP,DATEdb,
Date_F);
ALTER TABLE TOUR ADD FOREIGN KEY (idj) REFERENCES joueuse (idj);

ALTER TABLE deroule ADD FOREIGN KEY (idj) REFERENCES joueuse (idj);
ALTER TABLE deroule ADD FOREIGN KEY (idP,DATEdb, Date_F) REFERENCES partie (idP,DATEdb,
Date_F);

ALTER TABLE gagne ADD FOREIGN KEY (idj) REFERENCES joueuse (idj);
ALTER TABLE gagne ADD FOREIGN KEY (idP,DATEdb, Date_F) REFERENCES partie (idP,DATEdb,
Date_F);


INSERT INTO JOUEUSE VALUES(1,'David', '2024-11-09',NULL);
INSERT INTO JOUEUSE VALUES(2,'Anna', '2024-10-10',NULL);

INSERT INTO PARTIE VALUES(1,'2024-11-10 12:10:10.000', '2024-11-10 13:10:10.000','01:00:00.000');
INSERT INTO PARTIE VALUES(2, '2024-11-02 14:00:00.000', '2024-11-02 16:30:00.000', '02:30:00.000');
INSERT INTO PARTIE VALUES(3, '2024-07-06 08:00:00.000', '2024-07-06 10:00:00.000', '02:00:00.000');
...
INSERT INTO TOUR VALUES('2024-11-10 12:10:10.000','2024-11-10 13:10:10.000',1,1,1,TRUE,1);
INSERT INTO TOUR VALUES('2024-11-10 12:10:10.000','2024-11-10 13:10:10.000',2,1,56,FALSE,1);


INSERT INTO TOUR VALUES('2024-11-02 14:00:00.000', '2024-11-02 16:30:00.000', 1, 2, 101, TRUE, 2);
INSERT INTO TOUR VALUES('2024-11-02 14:00:00.000', '2024-11-02 16:30:00.000', 2, 2, 102, FALSE, 2);
INSERT INTO TOUR VALUES('2024-11-02 14:00:00.000', '2024-11-02 16:30:00.000', 3, 2, 201, TRUE, 2);

INSERT INTO TOUR VALUES('2024-07-06 08:00:00.000', '2024-07-06 10:00:00.000', 1, 3, 23, TRUE, 1);

INSERT INTO deroule VALUES(1, '2024-11-10 12:10:10.000','2024-11-10 13:10:10.000', 1, 25);

INSERT INTO deroule VALUES(2, '2024-11-02 14:00:00.000', '2024-11-02 16:30:00.000', 2, 40);

INSERT INTO deroule VALUES(3, '2024-07-06 08:00:00.000', '2024-07-06 10:00:00.000', 1, 30);
